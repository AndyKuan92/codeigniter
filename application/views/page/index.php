...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/favicon.png" rel="icon">
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/apple-touch-icon.png" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,400i,600,700|Raleway:300,400,400i,500,500i,700,800,900" rel="stylesheet">

  <!-- Bootstrap CSS File -->
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">

  <!-- Libraries CSS Files -->
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/nivo-slider/css/nivo-slider.css" rel="stylesheet">
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/owlcarousel/owl.carousel.css" rel="stylesheet">
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/owlcarousel/owl.transitions.css" rel="stylesheet">
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/animate/animate.min.css" rel="stylesheet">
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/venobox/venobox.css" rel="stylesheet">

  <!-- Nivo Slider Theme -->
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>css/nivo-slider-theme.css" rel="stylesheet">

  <!-- Main Stylesheet File -->
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>css/style.css" rel="stylesheet">

  <!-- Responsive Stylesheet File -->
  <link href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>css/responsive.css" rel="stylesheet">
...
<body data-spy="scroll" data-target="#navbar-example">
      ...
      <div class="row">
        ...
        <div class="awesome-project-content">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/1.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/1.jpg">
                      <h4>Business City</h4>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/2.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/2.jpg">
                      <h4>Blue Sea</h4>
                      <span>Photosho</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/3.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/3.jpg">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/4.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/4.jpg">
                      <h4>Creative Team</h4>
                      <span>Web design</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/5.jpg" alt="" /></a>
                <div class="add-actions text-center text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/5.jpg">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/6.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>img/portfolio/6.jpg">
                      <h4>Night Hill</h4>
                      <span>Photoshop</span>
                    </a>
                  </div>
  ...
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/jquery/jquery.min.js"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/bootstrap/js/bootstrap.min.js"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/owlcarousel/owl.carousel.min.js"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/venobox/venobox.min.js"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/knob/jquery.knob.js"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/wow/wow.min.js"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/parallax/parallax.js"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/easing/easing.min.js"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/nivo-slider/js/jquery.nivo.slider.js" type="text/javascript"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/appear/jquery.appear.js"></script>
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>lib/isotope/isotope.pkgd.min.js"></script>

  <!-- Contact Form JavaScript File -->
  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>contactform/contactform.js"></script>

  <script src="<?= base_url('assets/vendor/website_template/eBusiness/'); ?>js/main.js"></script>
</body>
